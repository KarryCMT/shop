  ...
  <div class="container">
    ...
    <div class="carousel">
      <van-swipe :autoplay="3000">
        <van-swipe-item class="carousel-item" v-for="(item, index) in images" :key="index">
          <img v-lazy="item.imgSrc" width="330" />
        </van-swipe-item>
      </van-swipe>
    </div>
    <!-- 热门商品 -->
      ...
      <swiper class="hot-swiper" :options="swiperOption">
        <swiper-slide v-for="(item,index) in hotProducts" :key="index">
          <div class="hot-swiper-content">
            ...
            <div class="hot-swiper-name">{{ item.name }}</div>
            <div class="hot-swiper-price">￥{{ item.price }}</div>
          </div>
        </swiper-slide>
      </swiper>
    </div>
    ...
    <div class="veriety">
      <p>推荐商品</p>
      <ul>
        <li class="veriety-item" v-for="(item, index) in verietyItem" :key="index">
          <img :src="item.img" alt />
          <p>{{item.name}}</p>
          <p>￥{{item.price}}</p>
        </li>
  ...
  data() {
    return {
      ...
      images: [
        {
          name: "img1",
          imgSrc: "http://lengnuanit.top/img/tm-img-01.jpg"
        },
        {
          name: "img2",
          imgSrc: "http://lengnuanit.top/img/tm-img-02.jpg"
        },
        {
          name: "img3",
          imgSrc: "http://lengnuanit.top/img/tm-img-03.jpg"
        },
        {
          name: "img4",
          imgSrc: "http://lengnuanit.top/img/tm-img-04.jpg"
        },
        {
          name: "img5",
          imgSrc: "http://lengnuanit.top/img/tm-img-05.jpg"
        }
      ],
      hotProducts: [
        // 热门商品
...
.veriety {
  ...
  ul{
    display: flex;
    flex-wrap: wrap; //换行 必须加在父元素上
    justify-content: space-around;//把剩余空间 均匀分布  两端保留子元素间距大小的一半
  }
  &-item{
    flex-basis: 45%;
  }
